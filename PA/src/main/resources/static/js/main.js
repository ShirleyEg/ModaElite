...
fetch("./js/productos.json")
    ...
    .then(data => {
        ...
        // Si estamos en la página principal, solo mostrar 4 productos destacados
...
// Detecta en qué página estás para marcar el botón activo
window.addEventListener('DOMContentLoaded', () => {
    const links = document.querySelectorAll('.boton-menu');
