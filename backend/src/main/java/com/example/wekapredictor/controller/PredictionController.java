package com.example.wekapredictor.controller;

import com.example.wekapredictor.model.PredictRequest;
import com.example.wekapredictor.service.WekaService;
...
public class PredictionController {
    ...
    public ResponseEntity<?> exportCSV() {
        try {
            ...
            com.example.wekapredictor.util.DatasetGenerator.exportToCSV(data, csvPath);
